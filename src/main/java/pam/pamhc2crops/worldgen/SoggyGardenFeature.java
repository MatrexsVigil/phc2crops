...
public class SoggyGardenFeature extends Feature<NoFeatureConfig> {
	public SoggyGardenFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactory) {
		super(configFactory);
	}
	...
	private BlockState getGarden(int type) {
			return BlockRegistry.soggygarden.getDefaultState();
