...
public class TropicalGardenFeature extends Feature<NoFeatureConfig> {
	public TropicalGardenFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactory) {
		super(configFactory);
	}
	...
	private BlockState getGarden(int type) {
			return BlockRegistry.tropicalgarden.getDefaultState();
