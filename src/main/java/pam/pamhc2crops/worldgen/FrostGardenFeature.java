...
public class FrostGardenFeature extends Feature<NoFeatureConfig> {
	public FrostGardenFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactory) {
		super(configFactory);
	}
	...
	private BlockState getGarden(int type) {
			return BlockRegistry.frostgarden.getDefaultState();
